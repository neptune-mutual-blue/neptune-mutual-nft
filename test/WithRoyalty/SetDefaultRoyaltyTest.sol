...
contract SetDefaultRoyalty is Spec {
  function testSetDefaultRoyaltyUnauthorized(uint96 feeNumerator) external {
  ...
  function testSetDefaultRoyalty(uint96 feeNumerator) external {
    vm.assume(feeNumerator > 0 && feeNumerator < 10_000);
