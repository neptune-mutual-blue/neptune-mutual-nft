...
contract DeleteDefaultRoyalty is Spec {
  function testDeleteDefaultRoyaltyUnauthorized() external {
  ...
  function testDeleteDefaultRoyalty(uint96 feeNumerator) external {
    ...
    require(royaltyReceiver == address(0), "Incorrect royalty receiver");
    require(royalty == 0, "Incorrect royalty");
